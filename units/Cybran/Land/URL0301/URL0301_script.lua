...
URL0301 = Class(CCommandUnit) {
    ...
    __init = function(self)
        CCommandUnit.__init(self, 'Viewer')
    end,
    ...
    CreateEnhancement = function(self, enh)
        ...
        elseif enh == 'FocusConvertor' then
			...
			self:GetWeaponByLabel('Viewer'):ChangeMaxRadius(bp.NewMaxRadius)
        elseif enh == 'FocusConvertorRemove' then
			...
			self:GetWeaponByLabel('Viewer'):ChangeMaxRadius(self:GetBlueprint().Weapon[1].MaxRadius)
