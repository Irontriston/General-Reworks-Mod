...
UAA0310 = Class(AirTransport) {
    ...
    OnAnimTerrainCollision = function(self, bone,x,y,z)
        DamageArea({Unit = self, Proj = 'CzarDeath' }, {x,y,z}, 5, 1000, 'Default', true, false)
        explosion.CreateDefaultHitExplosionAtBone(self, bone, 5.0)
        explosion.CreateDebrisProjectiles(self, explosion.GetAverageBoundingXYZRadiusCorrect(self), {self:GetUnitSizes()})
    end,
