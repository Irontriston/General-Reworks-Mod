...
UEB1104 = Class(TMassFabricationUnit) {
    ...
    CreateState = State {
        Main = function(self)
            ...
            self.SliderManip:SetGoal(0,-0.1,0)            #   so we have to hide the bone, close the unit,
            self.SliderManip:SetSpeed(-0.1)               #   and then show the bone once its in its closed position.
    ...
    ActiveState = State {
        Main = function(self)
            ...
            self.SliderManip:SetSpeed(0.29)
            WaitFor(self.SliderManip)
        end,
    ...
    InactiveState = State {
        Main = function(self)
            ...
            self.SliderManip:SetGoal(0,-0.1,0)
            self.SliderManip:SetSpeed(0.29)
            WaitFor(self.SliderManip)
        end,
