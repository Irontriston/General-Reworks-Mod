...
UEL0401 = Class(TMobileFactoryUnit) {
    ...
    IdleState = State {
        ...
        Main = function(self)
            ...
            self.AttachmentSliderManip:SetSpeed(-4)
        end,
    },
    ...
    BuildingState = State {
        Main = function(self)
            ...
            if not self.UnitBeingBuilt.Dead then
                ...
                local unitHeight = 0
				if EntityCategoryContains(unitBuilding, 'BOT') then
					unitHeight = unitBuilding:GetBlueprint().SizeY*0.4
				end
    ...
    RollingOffState = State {
        Main = function(self)
            ...
            self.AttachmentSliderManip:SetSpeed(2)
            self.AttachmentSliderManip:SetGoal(0, 0, 3.5)
            WaitFor(self.AttachmentSliderManip)

            self.AttachmentSliderManip:SetGoal(0, -0.3, 3.5)
            WaitFor(self.AttachmentSliderManip)
