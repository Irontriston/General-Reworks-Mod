...
UEB0304 = Class(TQuantumGateUnit) {
    ...
    OnStopBeingBuilt = function(self, builder, layer)
        ...
        self.GateEffectEntity:SetMesh('/mods/GeneralReworks/hook/effects/entities/ForceField01/ForceField01_mesh')
        self.GateEffectEntity:SetDrawScale(self.GateEffectScale)
        self.GateEffectEntity:SetParentOffset(Vector(0, self.GateEffectVerticalOffset, 0))
